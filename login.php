...
<html lang="pt">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login VitalPRÓ App</title>
            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Vital PRÓ App Login</h1>
                        <p>  </p>
                        <form action="pages/controller/Login.php" class="login-form" method="post">
                            <div class="alert alert-danger display-hide">
                                <button class="close" data-close="alert"></button>
                                <span>Informe usuário e senha </span>
                            </div>
                            <div class="row">
                                <div class="col-xs-6">
                        ...
                        <form class="forget-form" action="javascript:;" method="post">
                            ...
                            <p> Informe seu e-mail abaixo para resetar sua senha </p>
                        ...
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Vital PRÓ 2017</p>
                                </div>
                            </div>
                        </div>
                    </div>
