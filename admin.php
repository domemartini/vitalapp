...
<html lang="en">
    ...
    <head>
        ...
        if (isset($_GET['page'])) {
            $pgAtual = $_GET['page'];
            echo "<title>" . substr_replace($pgAtual, '', 0, 3) . " - VitalPRÓ</title>";
        } else {
            echo "<title>VitalPRÓ App</title>";
        }
        ?>        
    </head>
    <!-- END HEAD -->
...
<![endif]-->
        ...
        <script src="assets/global/plugins/maskedinput-master/src/jquery.maskedinput.js" type="text/javascript"></script>
