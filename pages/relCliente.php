                                                ...
                                                <div class="table-scrollable">
                                                    <table class="table table-hover">
                                                        ...
                                                        if (isset($comando) && $comando->rowCount() > 0) {
                                                            echo "<thead>";
                                                            echo "  <tr>";
                                                            echo "      <th>Nome</th><th>Data Nascimento</th><th>Telefone</th><th>Plano</th><th></th>";
                                                            echo "  </tr>";
                                                            echo "</thead>";
                                                            ...
                                                            while ($linha = $comando->fetch(PDO::FETCH_ASSOC)) {
                                                                echo "<tr>";
                                                                echo "  <td>" . $linha ["nome"] . "</td><td>" . $linha ["datanascimento"] . "</td><td>" . $linha ["telefone"] . "</td><td>" . $linha ["plano"] . " </td>";
                                                                echo "</tr>";
                                                            }
                                                            echo "</tbody>";
                                                        }
